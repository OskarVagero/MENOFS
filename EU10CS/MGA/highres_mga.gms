...
$setglobal datafolderpath "../4_model_data"
...
eq_obj .. objective =E=
var_exist_pcap_z("Wind","SE") + var_new_pcap_z("Wind","SE")
;


eq_cost.. var_system_costs =E= sum(z,
...
eq_cost_slack.. var_system_costs =L= (1+par_slack)*par_optimal_cost;
